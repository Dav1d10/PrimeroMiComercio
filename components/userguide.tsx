...
export const UserGuide = () => {
  return (
    <div className="w-64 rounded-lg bg-black border border-zinc-200 overflow-hidden">
      <div className="flex items-center mb-4 p-4">
        <BookOpen className="h-6 w-6 text-white mr-3" />
        <h1 className="text-xl font-bold text-white">Guía de Usuario</h1>
      </div>

      <div className="bg-black p-4 rounded-md shadow-sm border border-zinc-200 mx-4 mb-4">
        ...
        <h2 className="text-lg font-semibold text-white mt-4">¿Qué cálculos realiza el Asistente?</h2>
        ...
        <h2 className="text-lg font-semibold text-white mt-4">¿Cómo ingresar información?</h2>
        ...
        <h2 className="text-lg font-semibold text-white mt-4">Consultas y Ayuda</h2>
        <p className="text-white text-sm mt-2">
        ...
        <h2 className="text-lg font-semibold text-white mt-4">Cierre de Sesión</h2>
        <p className="text-white text-sm mt-2">
          Utiliza el enlace en la esquina superior derecha de la pantalla.
        </p>

        <p className="text-white text-xs italic mt-4">*Si necesitas ayuda adicional, escribe "ayuda" en el chat.*</p>
      </div>
    </div>
  );
};
